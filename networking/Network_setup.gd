...
var player = load("res://scenes/playerScenes/Player.tscn")
...
func instance_player(id) -> void:
	var player_instance = Global.instance_node_at_location(player, Players, Vector2(rand_range(-300,300),rand_range(-300,300)))
